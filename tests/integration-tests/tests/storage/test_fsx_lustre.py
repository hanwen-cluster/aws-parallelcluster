...
def test_multiple_fsx(
    ...
    num_existing_fsx_ontap_volumes = 0  # China and Isolated do not have Ontap
    num_existing_fsx_open_zfs_volumes = 0  # China, GovCloud and Isolated do not have OpenZFS.

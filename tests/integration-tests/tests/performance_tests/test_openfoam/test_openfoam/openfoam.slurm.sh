...
# E.g.: with 1152 processes using compute nodes c6in.32xlarge with multithreading disabled, the value should be 1152 / (72/2) = 32
# E.g.: with 576 processes using compute nodes c6in.32xlarge with multithreading disabled, the value should be 576 / (72/2) = 16
# E.g.: with 288 processes using compute nodes c6in.32xlarge with multithreading disabled, the value should be 288 / (72/2) = 8
NODES=${2}

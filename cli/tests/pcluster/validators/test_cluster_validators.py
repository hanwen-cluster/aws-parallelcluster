...
@pytest.mark.parametrize(
    ...
    [
        # EFAGDR without EFA
        ("c6in.32xlarge", False, True, True, False, "GDR Support can be used only if EFA is enabled"),
        # EFAGDR with EFA
        ("c6in.32xlarge", True, True, True, False, None),
        # EFA without EFAGDR
        ("c6in.32xlarge", True, False, True, False, None),
        ...
        ("c6in.32xlarge", False, False, True, True, None),
    ],
)
        ...
        return_value=InstanceTypeInfo(
            {
                ...
                "NetworkInfo": {
                    "EfaSupported": instance_type == "c6in.32xlarge",
